...
Compile from source:
    ...
    go get -u github.com/japanoise/hecate
...
If that weren't exciting enough, you can move the cursor around using Emacs-like
...
changes and press **enter** again to write changes to disk. Pressing **C-g**
...
<table>
<tr><td>C-b</td><td>left</td><td>t</td><td>text mode</td><td>S</td><td>show tabs</td></tr>
<tr><td>C-n</td><td>down</td><td>p</td><td>bit pattern mode</td><td>W</td><td>hide tabs</td></tr>
<tr><td>C-p</td><td>up</td><td>i</td><td>integer mode</td><td>A</td><td>previous tab</td></tr>
